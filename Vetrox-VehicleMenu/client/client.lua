...
local function getOptions(veh)
    ...
    for bType, info in pairs(Bones) do
        ...
        for i, data in ipairs(info) do
            ...
            local boneid = boneName == 'seat_dside_r1' and GetEntityBoneIndexByName(veh, boneName) == -1 and GetEntityBoneIndexByName(veh, 'seat_dside_r2') or GetEntityBoneIndexByName(veh, boneName) or GetEntityBoneIndexByName(veh, boneName)
...
RegisterNetEvent('vehiclemenu:client:open', function()
...
RegisterKeyMapping("OpenVehicleMenu", "Vehicle Menu", "keyboard", "end")
